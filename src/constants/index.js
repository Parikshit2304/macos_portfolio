...
const socials = [
  {
    ...
    bg: "#000000",
    link: "https://github.com/Parikshit2304",
  },
  {
    id: 2,
    text: "LeetCode",
    ...
    bg: "#FFA116",
    link: "https://leetcode.com/u/Parikshit230704",
  },
  {
    id: 3,
    text: "Twitter",
  ...
  },
  {
    ...
    bg: "#0077B5",
    link: "https://www.linkedin.com/in/parikshit-pandey-15249b247/",
  },
];
  ...
  children: [
    // ▶ Project 1
    {
      ...
      children: [
        {
          id: 101,
          name: "UptimeMonitor.txt",
          icon: "/images/txt.png",
          kind: "file",
          fileType: "txt",
          position: "top-5 left-10",
          description: [
            "UptimeMonitor is a full-stack, Software as a Service (SaaS)-style web application designed to monitor the availability and performance of internal and external web services in real time. It integrates a Node.js backend with a React.js (Vite) frontend and Prisma Object Relational Mapper (ORM) for database management.",
"Key features : ",
                "• Automated cron-based monitoring engine, multi-channel alerting (Email & SMS)", 
                "• Innovative predictive outage analysis model powered bythe Google Gemini Artificial Intelligence (AI) Application Programming Interface (API). ",
                "• The system provides a rich analytics dashboard and supports multi-tier subscriptions via Stripe integration."
          ],
        },
        {
          id: 102,
